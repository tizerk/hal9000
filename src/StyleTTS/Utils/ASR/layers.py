...
class CausualBlock(nn.Module):
    def __init__(self, hidden_dim, n_conv=3, dropout_p=0, activ="lrelu"):
    ...
    def _get_conv(self, hidden_dim, dilation, activ="lrelu", dropout_p=0):
        layers = [
            CausualConv(
                hidden_dim,
                hidden_dim,
...
class ConvBlock(nn.Module):
    def __init__(self, hidden_dim, n_conv=3, dropout_p=0, activ="relu"):
        super().__init__()
        self._n_groups = 8
        self.blocks = nn.ModuleList(
            [
    ...
    def _get_conv(self, hidden_dim, dilation, activ="relu", dropout_p=0):
        layers = [
            ConvNorm(
                hidden_dim,
                hidden_dim,
